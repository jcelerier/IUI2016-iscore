...
protocol. This have been done for Pure Data, Max/MSP (via the Jamoma framework), Quartz Composer, and Qt. The Minuit protocol can use UDP transport (via OSC messages) or TCP transport over websockets. The OSCQuery %cite
