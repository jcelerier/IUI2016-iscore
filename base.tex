...
In addition, we will present later in this paper an overview of relevant object model paradigms. This is used to explain the family of software that i-score is expected to control and direct. % Peut-être mettre ça ailleurs, plus loin ?
